...
router.route("/create").post(uploadOneImage("brand_image"),BrandController.createBrand);
router.route("/getById/:brandId").get(BrandController.getBrandById);
router.route("/getAll").get(BrandController.getAllBrands);
router.route("/update/:brandId").patch(uploadOneImage("brand_image"),BrandController.updateBrandById);
