...
class ProductCategoryGroupController {
  static async createProductCategoryGroup(req, res) {
    new CREATED({
      ...
      metadata: await ProductCategoryGroupService.createProductCategoryGroup(
        req,
        res
      ),
    }).send(res);
  ...
  static async getAllProductCategoriesGroup(req, res) {
    new OK({
      ...
      metadata: await ProductCategoryGroupService.getAllProductCategories(
        req,
        res
      ),
    }).send(res);
  ...
  static async getProductCategoryGroupById(req, res) {
    new OK({
      ...
      metadata: await ProductCategoryGroupService.getProductCategoryGroupById(
        req,
        res
      ),
    }).send(res);
  ...
  static async updateProductCategoryGroup(req, res) {
    new OK({
      ...
      metadata: await ProductCategoryGroupService.updateProductCategoryGroup(
        req,
        res
      ),
    }).send(res);
  ...
  static async deleteProductCategoryGroup(req, res) {
    new OK({
      ...
      metadata: await ProductCategoryGroupService.deleteProductCategoryGroup(
        req,
        res
      ),
    }).send(res);
