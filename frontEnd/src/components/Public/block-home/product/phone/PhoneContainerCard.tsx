...
// const PhoneContainerCardStyled = styled.div`
//   padding: 0 6px;
//   overflow: hidden;
// `;

// // All withCard + all with Gap(1rem)
// const ContainerCard = styled.div<{ $withCard: number; $gap: number }>`
//   display: flex;
...
//       return css`
//         ${(props.$withCard * products.length) / 2 +
//         props.$gap * (products.length / 2)}rem
//       `;
//     return css`
//       ${props.$withCard * products.length +
//       props.$gap * (products.length / 2)}rem
//     `;
//   }};
// `;
...
//   return (
//     <PhoneContainerCardStyled>
//       <Carousel
//         gapValue={1}
//         widthCard={23}
//         numberProductDisplay={5}
//         numberProductInRow={products.length / 2}
//       >
//         <ContainerCard $withCard={23} $gap={1}>
//           {products.map((product) => (
//             <Card item={product} key={Math.ceil(Math.random() * 1000000)} />
//           ))}
//         </ContainerCard>
//       </Carousel>
//     </PhoneContainerCardStyled>
